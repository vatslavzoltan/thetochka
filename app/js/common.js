$(function () {
	...
	$('.open-price-list').magnificPopup({
		type: 'inline',
		midClick: true
	});
	//end
	$('#get_currier_open').click(function (e) {
		e.preventDefault();
		$('.get_currier').toggleClass('active');
	});
...
$('#page_menu a[href*="#"],.header_anchor').on('click', function (e) {
	e.preventDefault();
	$('#page_menu li').removeClass('active');
